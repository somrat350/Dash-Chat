...
const Location = () => {
    return (
        <section className="py-20 bg-gray-50">
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Visit Our  <span className="text-primary">Office</span></h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-gray-900">support@dashchat.com</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">123 Business Avenue, Floor 5</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Business Hours */}
     <div className="bg-gradient-to-br from-green-400 to-green-200 p-8 rounded-3xl text-gray-800 shadow-xl hover:shadow-2xl transition duration-300">
  <h4 className="text-2xl font-bold mb-6 text-center">Business Hours</h4>
