...
const Privacy = () => {
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-2xl  text-gray-700 leading-relaxed">
              ...
              your personal messages, photos, and calls stay between
              you and the people you choose — meaning not even DashChat
              can see them.
            </p>
          </div>
  ...
  <div className="max-w-6xl mx-auto px-4 text-center">
    ...
    <h3 className="text-4xl  font-semibold text-gray-800 ">
      ...
      silly inside jokes, DashChat privacy helps your  <br />conversations stay protected.
    </h3>
  ...
  <div className="p-8 bg-gray-50 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
    ...
    <p className="text-gray-600 leading-relaxed">
      Beyond end-to-end encryption, DashChat offers additional 
      layers of protection to keep all of your conversations secure.
    </p>
  </div>
  ...
  <div className="p-8 bg-gray-50 rounded-2xl shadow-md hover:shadow-xl transition duration-300">
    ...
    <p className="text-gray-600 leading-relaxed">
      With DashChat privacy settings, you choose what you share, 
      how you appear online, and who can contact you.
    </p>
  </div>
    ...
    <div className="grid md:grid-cols-2 gap-12 items-center">
      ...
      <div>
        ...
        <p className="text-gray-700 text-lg leading-relaxed mb-8">
          Every message you send is protected with advanced 
          encryption technology. Your chats, calls, and shared 
          media remain completely secure and visible only to you 
          and the recipient.
        </p>
      ...
      <div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-600 leading-relaxed">
              Add an extra layer of protection to your account by enabling two-step verification in settings.
            </p>
          </div>
          ...
          <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-600 leading-relaxed">
              Make sure your chats are end-to-end encrypted. Only you and the recipient can read the messages.
            </p>
          </div>
          ...
          <div className="p-6 bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
            ...
            <p className="text-gray-600 leading-relaxed">
              Avoid clicking on suspicious links and never share your verification codes with anyone.
            </p>
          </div>
        </div>
      </div>
