...
const filteredUsers = users
     ...
     {/* header area  */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-base-300">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-lg">DashChat</h2>
        </div>

        <div className="flex items-center gap-3">
          <button className="hover:bg-base-200 p-2 rounded-full">
            <Plus size={20} />
          </button>
          <button className="hover:bg-base-200 p-2 rounded-full">
      ...
      {/* search field area*/}
      <div className="p-3">
        <div className="flex items-center bg-base-200 rounded-full px-3">
  ...
  {filteredUsers.length > 0 ? (
    filteredUsers.map((user, index) => (
      <div
        key={index} 
        className="flex items-center justify-between px-4 py-3 hover:bg-base-200 cursor-pointer transition"
      >
