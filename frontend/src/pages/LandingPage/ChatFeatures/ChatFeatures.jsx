            ...
            >
              ...
              <div className="relative p-8 flex flex-col items-center text-center">
                ...
                <div className="relative mb-6">
                  <div className={`w-28 h-28 rounded-2xl bg-gradient-to-br ${feature.color} bg-opacity-10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
                  ...
                  {/* Decorative Dot */}
                  <div className={`absolute -bottom-2 -right-2 w-6 h-6 rounded-full bg-gradient-to-br ${feature.color} border-4 border-white`}></div>
                </div>
