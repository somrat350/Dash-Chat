...
const Contact = () => {
 ...
 <div className="bg-base-100 min-h-screen">
  {/*headerr */}
 <section className="py-20 bg-primary rounded-3xl relative overflow-hidden">
  ...
  <div className="max-w-7xl mx-auto px-4 md:px-16">
    <div className="grid md:grid-cols-2 gap-12 items-start">
      ...
      {/* Left Card */}
      <div className="p-10 md:p-14 bg-base-200 rounded-3xl shadow-xl border-2 border-transparent hover:border-primary -mt-32 relative z-20 transition-all duration-300">
...
<section className="py-16 bg-base-100 relative z-40 -mt-24">
  <div className="max-w-7xl mx-auto px-4 md:px-16">

    <div className="grid md:grid-cols-2 gap-12 items-start">

      {/* Left Form */}
    <div className="bg-base-200 p-10 rounded-xl border-2 border-transparent hover:border-primary shadow-sm transition-all duration-300">
  ...
  <div className="bg-base-200 p-6 rounded-lg border-2 border-transparent hover:border-primary flex items-center gap-6 hover:shadow-md transition-all duration-300">
...
<section className="py-24 bg-base-100">
  <div className="max-w-4xl mx-auto px-6">
    ...
    <div className="space-y-4">
      ...
      {/* Q1 */}
      <div className="group bg-base-200 p-6 rounded-xl border border-base-300 shadow-sm hover:shadow-md hover:border-primary/30 transition-all duration-300">
        <div className="flex justify-between items-center cursor-pointer">
          <h4 className="text-xl font-bold text-base-content group-hover:text-primary transition-colors">
            How long does it take to respond?
          </h4>
          <span className="text-2xl text-base-content/40 group-hover:rotate-45 transition-transform duration-300">+</span>
        </div>
