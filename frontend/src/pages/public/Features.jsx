...
<section className="py-24 bg-base-100"> 
  ...
  <div className="bg-base-200 p-8 rounded-[32px] border border-transparent hover:border-primary shadow-sm hover:shadow-xl transition-all duration-300 group">
    ...
    <h3 className="text-2xl font-bold text-base-content mb-4 text-left">HD Video Calling</h3>
  ...
  <div className="bg-base-200 p-8 rounded-[32px] border border-transparent hover:border-primary shadow-sm hover:shadow-xl transition-all duration-300 group">
    ...
    <h3 className="text-2xl font-bold text-base-content mb-4 text-left">Voice Messages</h3>
    <p className="text-gray-400 leading-relaxed text-left">
  ...
  <div className="bg-base-200 p-8 rounded-[32px] border border-transparent hover:border-primary shadow-sm hover:shadow-xl transition-all duration-300 group">
    ...
    <h3 className="text-2xl font-bold text-base-content mb-4 text-left">Screen Sharing</h3>
    <p className="text-gray-400 leading-relaxed text-left">
...
<section className="py-24 bg-base-100">
  <div className="max-w-7xl mx-auto px-6 md:px-16">
    ...
    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <div className="group bg-base-200 p-8 rounded-[32px] border border-transparent 
        ...
        <h3 className="text-2xl font-bold text-base-content mb-4">Emoji Reactions</h3>
  ...
  <MessageSquare size={28} className="text-purple-600 dark:text-purple-100 group-hover:text-white"/>
</div>
        <h3 className="text-2xl font-bold text-base-content mb-4">Threaded Replies</h3>
        <p className="text-gray-400 leading-relaxed">
      ...
      <div className="group bg-base-200 p-8 rounded-[32px] border border-transparent 
        ...
        <div className="w-14 h-14 bg-orange-100 dark-bg-orange-700 rounded-2xl flex items-center justify-center group-hover:bg-primary  transition-all">
          <Search size={28} className="text-orange-600 dark:text-orange-100 group-hover:text-white" />
        </div>
        <h3 className="text-2xl font-bold text-base-content mb-4">Powerful Search</h3>
        <p className="text-gray-400 leading-relaxed">
      ...
      <div className="group bg-base-200 p-8 rounded-[32px] border border-transparent 
        ...
        <div className="w-14 h-14 bg-red-100  dark-bg-red-700 rounded-2xl flex items-center justify-center group-hover:bg-primary  transition-all">
          <Eraser size={28} className="text-red-600 dark:text-red-100 group-hover:text-white" />
        </div>
        <h3 className="text-2xl font-bold text-base-content mb-4">Edit & Delete</h3>
        <p className="text-gray-400 leading-relaxed">
      ...
      <div className="group bg-base-200 p-8 rounded-[32px] border border-transparent 
        ...
        <div className="w-14 h-14 bg-green-100 dark-bg-green-700 rounded-2xl flex items-center justify-center group-hover:bg-primary  transition-all">
          <Pin size={28} className="text-green-600 dark:text-green-100 group-hover:text-white" />
        </div>
        <h3 className="text-2xl font-bold text-base-content mb-4">Pinned Messages</h3>
        <p className="text-gray-400 leading-relaxed">
      ...
      <div className="group bg-base-200 p-8 rounded-[32px] border border-transparent 
        ...
        <div className="w-14 h-14 bg-blue-100 dark-bg-green-700 rounded-2xl flex items-center justify-center group-hover:bg-primary  transition-all">
          <AtSign size={28} className="text-blue-600 dark:text-blue-100 group-hover:text-white"  />
        </div>
        <h3 className="text-2xl font-bold text-base-content mb-4">Direct Mentions</h3>
        <p className="text-gray-400 leading-relaxed">
...
<section className="py-24 bg-base-100">
  <div className="max-w-7xl mx-auto px-6">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
      ...
      {/* Card 1 */}
      <div className="p-8 rounded-3xl bg-base-200 border border-transparent hover:border-primary hover:shadow-xl transition-all group">
        <div className="w-12 h-12 bg-blue-100 rounded-xl flex items-center justify-center text-blue-600 mb-6 ">
          <Edit3 size={24} />
        </div>
        <h3 className="font-bold text-xl mb-2 text-base-content">Typing Indicators</h3>
        <p className="text-base-content/70 text-sm">
          See when your friends are typing in real-time, making chats feel alive.
        </p>
      </div>
      ...
      <div className="p-8 rounded-3xl bg-base-200 border border-transparent hover:border-primary hover:shadow-xl transition-all group">
        ...
        <h3 className="font-bold text-xl mb-2 text-base-content">Live Presence</h3>
        <p className="text-base-content/70 text-sm">
          Know exactly when your contacts are online or when they were last seen.
        </p>
      </div>
      ...
      <div className="p-8 rounded-3xl bg-base-200 border border-transparent hover:border-primary hover:shadow-xl transition-all group">
        ...
        <h3 className="font-bold text-xl mb-2 text-base-content">Read Receipts</h3>
        <p className="text-base-content/70 text-sm">
          Stay informed with delivered and seen indicators for every message sent.
        </p>
      </div>
      ...
      <div className="p-8 rounded-3xl bg-base-200 border border-transparent hover:border-primary hover:shadow-xl transition-all group">
        ...
        <h3 className="font-bold text-xl mb-2 text-base-content">Cloud Storage</h3>
        <p className="text-base-content/70 text-sm">
          Your chats are saved forever. Access your history from any device, anytime.
        </p>
      </div>
